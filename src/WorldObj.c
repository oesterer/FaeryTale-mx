...
/* Definition Module WorldObj */
#ifndef WORLDOBJ_H
#define WORLDOBJ_H

typedef struct WorldObject WorldObject;
static const int32_t ObjFireScroll = 164;
static const int32_t ObjFruit = 148;
static const int32_t ObjBStone = 18;
static const int32_t ObjShell = 151;
static const int32_t ObjWolfsbane = 157;
static const int32_t MaxWorldObjs = 1600;
static const int32_t ObjUrn = 14;
static const int32_t ObjTurtle = 102;
static const int32_t ObjHealScroll = 169;
static const int32_t ObjRedKey = 242;
static const int32_t ObjScrap = 20;
static const int32_t ObjMugwort = 158;
static const int32_t ObjLightScroll = 166;
static const int32_t ObjMandrake = 156;
static const int32_t ObjStatue = 149;
static const int32_t ObjMWand = 145;
static const int32_t ObjFearScroll = 165;
static const int32_t ObjGreenKey = 153;
static const int32_t ObjJSkull = 24;
static const int32_t ObjFreezeScroll = 163;
static const int32_t ObjBTotem = 23;
static const int32_t ObjBloodroot = 161;
static const int32_t ObjYarrow = 159;
static const int32_t ObjFootstool = 31;
extern int32_t objCount;
static const int32_t ObjMoney = 13;
static const int32_t MaxRegionObjs = 80;
static const int32_t ObjMeal = 146;
static const int32_t ObjChest = 15;
static const int32_t ObjHarvestScroll = 168;
static const int32_t ObjQuiver = 11;
static const int32_t ObjGreyKey = 26;
static const int32_t ObjRose = 147;
static const int32_t ObjWhiteKey = 154;
static const int32_t ObjSanctuaryScroll = 167;
static const int32_t ObjGRing = 17;
static const int32_t ObjCOrb = 21;
static const int32_t ObjGoldKey = 25;
static const int32_t ObjNightshade = 160;
static const int32_t ObjGJewel = 19;
static const int32_t ObjVial = 22;
static const int32_t ObjWardScroll = 162;
static const int32_t ObjSacks = 16;
static const int32_t ObjBook = 150;
static const int32_t ObjBlueKey = 114;
extern int revealHidden;
void SetRegionDistributed(int32_t region, int value);
void AddObj(int32_t x, int32_t y, int32_t id, int32_t m2_stat, int32_t reg);
void DrawWorldObjects(void);
void InitWorldObjects(void);
void LeaveItem(int32_t x, int32_t y, int32_t id);
int IsRegionDistributed(int32_t region);
void LoadObjectSprites(void);
int32_t CheckObjectPickup(int32_t heroX, int32_t heroY);
void DistributeRegion(int32_t region);
extern void * objTex;
...
extern WorldObject objects[1599 + 1];
