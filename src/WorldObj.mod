...
BEGIN
  ...
  AddObj(18732, 15456, 19, 3, 3);    (* Brann Oakhand *)
  AddObj(18892, 15456, 20, 3, 3);    (* Mara Caskwell *)
  AddObj(19052, 15456, 21, 3, 3);    (* Orruk the Gentle *)
  AddObj(19212, 15456, 22, 3, 3);    (* Kett Redcap *)
  AddObj(19372, 15456, 23, 3, 3);    (* Nella Hearth *)
  AddObj(19532, 15456, 24, 3, 3);    (* Tovin Reed *)
  AddObj(19692, 15456, 25, 3, 3);    (* Borga Stoneback *)
  AddObj(19852, 15456, 26, 3, 3);    (* Elsa Vine *)
  AddObj(18796, 15552, 27, 3, 3);    (* Perrin Quill *)
  AddObj(18956, 15552, 28, 3, 3);    (* Grum Barley *)
  AddObj(19116, 15552, 29, 3, 3);    (* Lysa Doorward *)
  AddObj(19276, 15552, 30, 3, 3);    (* Hobb Flint *)
  AddObj(19436, 15552, 31, 3, 3);    (* Anka Blueglass *)
  AddObj(19596, 15552, 32, 3, 3);    (* Rusk Fen *)
  AddObj(19756, 15552, 33, 3, 3);    (* Maud Ash *)
