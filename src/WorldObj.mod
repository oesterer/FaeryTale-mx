...
BEGIN
  ...
  AddObj(18740, 15690, 19, 3, 3);    (* Brann Oakhand *)
  AddObj(18960, 15840, 20, 3, 3);    (* Mara Caskwell *)
  AddObj(19120, 15480, 21, 3, 3);    (* Orruk the Gentle *)
  AddObj(19580, 15790, 22, 3, 3);    (* Kett Redcap *)
  AddObj(19830, 15390, 23, 3, 3);    (* Nella Hearth *)
  AddObj(20120, 15180, 24, 3, 3);    (* Tovin Reed *)
  AddObj(20420, 15740, 25, 3, 3);    (* Borga Stoneback *)
  AddObj(20720, 15440, 26, 3, 3);    (* Elsa Vine *)
  AddObj(21020, 15810, 27, 3, 3);    (* Perrin Quill *)
  AddObj(21320, 15380, 28, 3, 3);    (* Grum Barley *)
  AddObj(21620, 15690, 29, 3, 3);    (* Lysa Doorward *)
  AddObj(21920, 15420, 30, 3, 3);    (* Hobb Flint *)
  AddObj(22220, 15820, 31, 3, 3);    (* Anka Blueglass *)
  AddObj(22520, 15540, 32, 3, 3);    (* Rusk Fen *)
  AddObj(22820, 15770, 33, 3, 3);    (* Maud Ash *)
